...
<?php
  ...
  //var_dump($_SESSION);
  $arrParametros	 = array('id_cliente'=>$_SESSION['id_cliente'],'id'=>$_SESSION['id_formulario_enlazado']);
  ...
  echo '<input type="hidden" name="id_formulario_enlazado" id="id_formulario_enlazado" value="'.$_SESSION['id_formulario_enlazado'].'">';  
  echo "<script>\n";  
