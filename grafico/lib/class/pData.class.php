 ...
 class pData
  {
   ...
   function addPoints($Values,$SerieName="Serie1",$color=array('R'=>255,'G'=>0,'B'=>0),$mostrarvalor=true,$flag=false,$valores=array(),$arrLeyenda=array(),$strTipoIcono=null)
    {
     ...
     if ( $Values != VOID )
	  ...
	  //$this->Data["Series"][$SerieName]['Color'] 	  = $color;	  
	  $this->Data["Series"][$SerieName]['mostrar'] 	  = $mostrarvalor;
	  $this->Data["Series"][$SerieName]['flag'] 	  = $flag;
	  $this->Data["Series"][$SerieName]['valores'] 	  = $valores;
 	  $this->Data["Series"][$SerieName]['tipo_icono'] = $strTipoIcono;
	  if(!empty($arrLeyenda)){
	    $this->Data["Leyenda"] = $arrLeyenda;	  	
	  }
    }
