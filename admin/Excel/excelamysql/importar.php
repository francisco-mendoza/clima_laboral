...
<body>
    ...
    if ($action == "upload") {
        ...
        if (file_exists("bak_" . $archivo)) {
            ...
            $cn = mysql_connect("localhost", "root", "Propro123") or die("ERROR EN LA CONEXION");
            $db = mysql_select_db("slorg_test", $cn) or die("ERROR AL CONECTAR A LA BD");
        ...
        foreach ($_DATOS_EXCEL as $campo => $valor) {
            $sql = "INSERT INTO tablatest VALUES (NULL,'";
            foreach ($valor as $campo2 => $valor2) {
                $campo2 == "apellido" ? $sql.= $valor2 . "');" : $sql.= $valor2 . "','";
            }
            echo $sql;
